...
const venueData = {
  ...
  "garden-area": {
    ...
    image: "/eventvenu/gardenarea.jpg",
  ...
  "event-setup": {
    ...
    image: "/eventvenu/eventsetup.webp",
          ...
          <div className="neweventvenue-layout-modal-content">
                ...
                <div className="neweventvenue-layout-modal-cons">
                  ...
                  <ul>
                    {layoutDetails[activeLayout].cons.map((con, index) => (
                      <li key={index}>
                        <i className="fas fa-info-circle"></i> {con}
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="neweventvenue-layout-modal-actions">
              <button
                ...
                onClick={handleBookingClick}
              >
                <i className="fas fa-calendar-alt"></i> Book This Layout
              </button>
              <button
